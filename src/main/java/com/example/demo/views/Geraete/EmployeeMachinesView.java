...
import com.example.demo.views.EmployeeLayout;
...
@Route(value = "mitarbeiter/geraete", layout = EmployeeLayout.class)
@PermitAll
public class EmployeeMachinesView extends VerticalLayout {

    private final GeraetService geraetService;
    private Grid<Geraet> geraetGrid;

    @Autowired
    public EmployeeMachinesView(GeraetService geraetService) {
