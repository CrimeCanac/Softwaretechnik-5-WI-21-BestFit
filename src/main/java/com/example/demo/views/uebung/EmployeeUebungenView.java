...
@Route(value = "mitarbeiter/uebungen", layout = ManagerLayout.class)
@PermitAll
public class EmployeeUebungenView extends VerticalLayout {
    ...
    @Autowired
    public EmployeeUebungenView(UebungService uebungService, GeraetService geraetService) {
