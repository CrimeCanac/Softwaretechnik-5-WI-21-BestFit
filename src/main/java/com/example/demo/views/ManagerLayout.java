...
public class ManagerLayout extends AppLayout {
    ...
    private Div createHeader() {
        ...
        adminViewLabel.setText("Geschäftsführer-Ansicht");
    ...
    private Div createDrawer() {
        ...
        menu.add(createDrawerMenuItem("Mitglieder", "/manager/members"));
        menu.add(createDrawerMenuItem("Mitarbeiter", "/manager/employees"));
